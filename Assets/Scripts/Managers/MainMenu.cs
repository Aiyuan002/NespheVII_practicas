...
public class MainMenu : MonoBehaviour
{
    ...
    [SerializeField]
    public float retrasoEntreElementos = 0.25f; // Retraso entre la aparici�n de los elementos

    [SerializeField]
    public float fadeDuration = 0.25f; // Duraci�n de la animaci�n fade-in
    ...
    [SerializeField]
    public float tiempoImagen = 6f; // Tiempo que cada imagen permanece visible antes de hacer la transici�n

    [SerializeField]
    public float fadeDurationImagen = 1f; // Duraci�n de la animaci�n fade-in y fade-out de la imagen
    ...
    {
        // Asegurarse de que ambas im�genes est�n activas desde el principio
